...
<head>
    ...
    <title>员工列表页面</title>
    <!-- request.getContextPath()是/ssmcrud -->
    <%
        pageContext.setAttribute("APP_PATH",request.getContextPath());
    %>

    <!-- web路径：
    不以/开始的相对路径，以当前资源的路径为基准，容易出现问题以/开始的相对路径，资源以服务器的路径为标准
	比如(http://localhost:3360):需要加上项目名http://localhost:3306/crud -->

    <!-- 不以/开始的相对路径 以当前资源路径为基准   以/开始的相对路径 以服务器的路径为标准（http://localhost:8080）-->
    <!-- Bootstrap -->
...
<body>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label for="inputGender" name="gender" class="col-sm-2 control-label">性别</label>
                            <div class="col-sm-10">
                                <label class="radio-inline">
    ...
    <script type="text/javascript">
        ...
        //1.$("#edit_btn").click(function()是在按钮创建之前绑定click，因此无法绑定
        //2.可以在按钮创建时绑定
        //新版本jquery使用，绑定编辑按钮的点击事件，使用on替代live
